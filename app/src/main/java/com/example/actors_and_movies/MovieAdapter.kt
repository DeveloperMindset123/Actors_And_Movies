...
//modified adapter to extend the type
class UpcomingMoviesAdapter(private val context: Context, private val articles: List<UpcomingMovie>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        //write a helper method that will help us set up onBindViewHolder method
        fun bind(movie: UpcomingMovie) {
            titleTextView.text = movie.headline?.main
            abstractTextView.text = movie.movie_overview

            Glide.with(context)
                .load(movie.movieBackdropPath)
                .into(mediaImageView)
        }
...
//make the second parameter in the constructor be of Movies datatype (a list of Movies)
